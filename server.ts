      ...
      const fallbackGrants = [
        {
          ...
          deadline: '2026-06-15',
          status: '접수마감임박',
          url: 'https://www.k-startup.go.kr/web/contents/bizpbanc-ongoing.do?schM=view&pbancSn=167232',
          target: '예비창업자',
          region: '전국'
        },
        {
          ...
          deadline: '2026-06-24',
          status: '접수중',
          url: 'https://www.k-startup.go.kr/web/contents/bizpbanc-ongoing.do?schM=view&pbancSn=167233',
          target: '초기창업(3년이내)',
          region: '전국'
        },
        {
          ...
          deadline: '2026-06-30',
          status: '접수중',
          url: 'https://www.sbiz24.kr/#/prg/bnef/bnefDetail?bnefCd=50502',
          target: '소상공인',
          region: '전국'
        },
        {
          ...
          deadline: '2026-06-10',
          status: '마감',
          url: 'https://start.kosmes.or.kr/main/board/notice/view.do?nttId=8040',
          target: '초기창업(3년이내)',
          region: '서울'
        },
        {
          ...
          deadline: '2026-07-10',
          status: '접수예정',
          url: 'https://www.k-startup.go.kr/web/contents/bizpbanc-ongoing.do?schM=view&pbancSn=167290',
          target: '도약기(7년이내)',
          region: '비수도권'
        },
        {
          ...
          deadline: '2026-07-15',
          status: '접수중',
          url: 'https://www.sbiz24.kr/#/prg/bnef/bnefDetail?bnefCd=50518',
          target: '소상공인',
          region: '경기'
        },
        {
          ...
          deadline: '2026-06-20',
          status: '접수중',
          url: 'https://www.k-startup.go.kr/web/contents/bizpbanc-ongoing.do?schM=view&pbancSn=167199',
          target: '재창업자',
          region: '전국'
        }
      ];
